...
(function () {
  ...
  CC.TAKEN = [
    ...
    { groep: 'Spelers opvolgen', k: 'afdoen', titel: 'Signalen afdoen', sub: '"Gezien, geen actie nodig"', std: [1, 1, 1, 1] },
    ...
    { groep: 'Trainers', k: 'trainerNiet', titel: 'Registreren dat de trainer niet kwam', sub: 'Bij de laatste trainingen', std: [0, 1, 0, 0] },

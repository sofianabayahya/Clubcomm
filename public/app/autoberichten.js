...
(function () {
  ...
  const STANDAARD = [
    ...
    { id: 'fase', naam: 'Nieuwe fase', wanneer: 'Start van fase 2, 3 en 4', dagen: 0, onderwerp: '[fase] begint', tekst: 'Vandaag begint [fase]. Kan je kind een keer niet? Meld het op tijd af in ClubComm.' },

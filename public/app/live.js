...
(function () {
  ...
  CC.loginScherm = () => {
    ...
    if (L.stap === 'code') return scherm(`<h1>Check je mail</h1><p class="zacht">We hebben een mail gestuurd naar <b>${esc(L.email)}</b>. Typ de code van 6 cijfers uit de mail hieronder over.</p>${foutRegel()}

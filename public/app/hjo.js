...
(function () {
  ...
  CC.on('regelsOk', (f) => {
    ...
    Object.assign(i, { deadlineTraining: n('dt'), deadlineWedstrijd: n('dw'), geel: n('g'), oranje: n('o'), oproepDagen: n('op'), waarschuwing: f.w.value, zones: { breedte: { groen: n('bg'), oranje: n('bo') }, selectie: { groen: n('sg'), oranje: n('so') } } });

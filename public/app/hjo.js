...
(function () {
  ...
  CC.on('regelsOk', (f) => {
    ...
    Object.assign(i, { deadlineTraining: n('dt'), deadlineWedstrijd: n('dw'), waarschuwingen: { breedte: n('wb'), selectie: n('ws') }, telaat: { breedte: { kort: n('tkb'), seizoen: n('tsb') }, selectie: { kort: n('tks'), seizoen: n('tss') } }, oproepDagen: n('op'), homeDagen: n('hd'), opnemenUur: n('ou'), waarschuwing: f.w.value, trainer: { deadlineUur: n('tu'), drempel: n('tp'), maxSeizoen: n('ts') }, zones: { breedte: { groen: n('bg'), oranje: n('bo') }, selectie: { groen: n('sg'), oranje: n('so') } } });

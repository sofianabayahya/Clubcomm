...
(function () {
  ...
  CC.on('regelsOk', (f) => {
    ...
    Object.assign(i, { deadlineTraining: n('dt'), deadlineWedstrijd: n('dw'), geel: n('g'), oranje: n('o'), oproepDagen: n('op'), homeDagen: n('hd'), waarschuwing: f.w.value, trainer: { deadlineUur: n('tu'), drempel: n('tp'), maxSeizoen: n('ts') }, zones: { breedte: { groen: n('bg'), oranje: n('bo') }, selectie: { groen: n('sg'), oranje: n('so') } } });

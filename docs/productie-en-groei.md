...
> *Uit de app-analyse van 26-09 (`docs/onderzoek/app-analyse-2026-09.md`), eerst:* "Club leegmaken"/"Voorbeelddata laden" weg uit de echte versie · contrast en tekstgrootte (donkerder blauw/groen/oranje, min. 12 px, tikdoelen 44 px) · app ververst zelf bij een nieuwe versie · foutregistratie in Supabase · generale repetitie wedstrijddag vóór de eerste oefenwedstrijd · testscripts in het project · Regels/Rollen/Inzicht opdelen · tabbladen gelijk trekken tussen rollen.
